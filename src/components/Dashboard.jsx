  ...
  return (
    <div className="stage-bar">
      ...
      <div className="stage-social">
        <a href="https://x.com/YoneCode" target="_blank" rel="noopener noreferrer" className="social-link" title="@YoneCode on X">
          <svg viewBox="0 0 24 24" className="social-icon" aria-hidden="true">
            <path d="M18.244 2.25h3.308l-7.227 8.26 7.92 10.49H16.17l-5.214-6.817L4.99 21H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
          </svg>
        </a>
        <a href="https://github.com/YoneCode" target="_blank" rel="noopener noreferrer" className="social-link" title="YoneCode on GitHub">
          <svg viewBox="0 0 24 24" className="social-icon" aria-hidden="true">
